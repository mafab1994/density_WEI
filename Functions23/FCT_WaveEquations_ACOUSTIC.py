...
def WE_2D_ACOUSTIC(FIELD_Z_gradXX, FIELD_Z_gradYY, FIELD_Z_gradZZ, FIELD_Z_gradXY, FIELD_Z_gradYX,  \
                   FIELD_Z_gradYZ, FIELD_Z_gradXZ, vp_sub, c_sub, dttv3, posX,posY, posZ, nf, f_filt_cent, filtered, t):
    ...
    fig, (ax3) = plt.subplots(figsize=(10,6),nrows=1)
    ...
    ax3.plot(t, rhs_eq3_2D[posX,posY,posZ,:,nf], label='lhs')
    ax3.plot(t, dttv3[posX,posY,posZ,:,nf], linestyle='-.', label ='dttv')
